...
```{r}
sim_bets <- function(num_bets, bank_start = 1000, max_iterations = 5000){
...
```{r}
mean(replicate(max_iterations,sim_bets(max_iterations)$bets))
```
    d. the mean and variance of your bankroll after 100 hands (including busts).
```{r}
mean(replicate(max_iterations, sim_bets(100)$bankroll))
var(replicate(max_iterations, sim_bets(100)$bankroll))
```
    e. the mean and variance of your bankroll after 500 hands (including busts).
```{r}
mean(replicate(max_iterations, sim_bets(500)$bankroll))
var(replicate(max_iterations, sim_bets(500)$bankroll))
```
